...
const TrustBadges: React.FC = () => {
  ...
  return (
    <section className="relative py-10 md:py-12 overflow-hidden">
      {/* Fixed Background Image with 2:9 aspect ratio - Only in this section */}
      <div 
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage: `url('/banner/service.jpg')`,
      ...
      <link rel="preload" as="image" href="/banner/service.jpg" />
