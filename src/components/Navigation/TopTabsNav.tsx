          ...
          <div className="inline-flex items-center gap-1 md:gap-2 bg-white rounded-full p-1 shadow-inner border-2 border-black">
            {categories.map((category) => (
              <button
                ...
                className={`px-3 md:px-6 py-2 rounded-full text-sm md:text-base font-semibold tracking-wide transition-all duration-300 disabled:opacity-50 ${
                      ...
                      return (
                        <div key={subcategory.id} className="relative flex-shrink-0">
                          <motion.button
                            ...
                            className={`px-3 md:px-4 py-2 md:py-2 text-sm md:text-sm font-medium rounded-full transition-all duration-300 whitespace-nowrap border-2 backdrop-blur flex items-center gap-2 min-w-[8rem] max-w-[12rem] ${
                              isActive
