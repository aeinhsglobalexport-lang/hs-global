        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-lg bg-gray-200">
            ...
            <div className="relative w-full h-[280px] md:h-[420px]">
              ...
              {/* YouTube Embed */}
              <iframe
  key={Date.now()} // 🔥 Forces fresh reload every time
  className="absolute inset-0 w-full h-full border-0"
  src={`https://www.youtube.com/embed/${YOUTUBE_VIDEO_ID}?start=0&rel=0&modestbranding=1&playsinline=1&controls=0&fs=0&autoplay=1&mute=1`}
