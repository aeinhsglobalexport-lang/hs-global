          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-2 border rounded-md focus:ring-accent focus:border-accent ${
            ...
            <div className="relative flex">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-4 py-2 border rounded-r-md focus:ring-accent focus:border-accent ${
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea
                ...
                onChange={handleChange}
                className={`w-full pl-10 pr-4 py-2 border rounded-md focus:ring-accent focus:border-accent min-h-[100px] ${
