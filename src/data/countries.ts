...
// Flag helper - use this component to render flags
// Usage: <FlagImage code="US" /> or <FlagImage code="IN" />
export const getFlagUrl = (countryCode: string, size: '16x12' | '24x18' | '48x36' = '24x18') => 
