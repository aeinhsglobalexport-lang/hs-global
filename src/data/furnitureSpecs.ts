// src/data/furnitureSpecs.ts - Complete USD pricing version
...
// ⭐ Helper to convert INR to USD (using rate ~89.5)
const INRtoUSD = (inr: number) => Math.round(inr / 89.5);
...
const furnitureSpecsData: Record<string, FurnitureSpec> = {
  ...
  'black rectangular block': {
    ...
    packagingDetails: 'As per requirement',
    location: 'India',
    priceUSD: INRtoUSD(247499), // 2765
    etsyUrl: 'https://www.etsy.com/in-en/listing/4399292262/black-green-marble-block-coffee-tables',
  },
